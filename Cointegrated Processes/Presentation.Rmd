...
knitr::include_graphics("Structural Break.png")
```
...
knitr::include_graphics("Gold_ADF.JPG")
```
...
```{r, echo=FALSE, out.width="50%"}
knitr::include_graphics("Gold_Diff_ADF.JPG")
```
...
```{r, echo=FALSE, out.width="50%"}
knitr::include_graphics("Silver_ADF.JPG")
```
...
```{r, echo=FALSE, out.width="50%"}
knitr::include_graphics("Silver_Diff_ADF.JPG")
```
...
knitr::include_graphics("Gold_Silver_ECM.jpg")
```
...
```{r, echo=FALSE, fig.align = 'center', out.height="20%", out.width="60%"}
knitr::include_graphics("Gold_Copper_Line_Chart.JPG")
```
...
knitr::include_graphics("Copper_ADF_Test.jpg")
```
...
knitr::include_graphics("Copper_ADF_Test(diff).jpg")
```
...
```{r, echo=FALSE, fig.align='left', out.width="70%"}
knitr::include_graphics("Gold_Copper_Residual_ADF_Test.JPG")
```
...
```{r, echo=FALSE}
knitr::include_graphics("TY2.jpg")
```
